...
# endif
# if (defined RTE_CONST_NXTR_MANUFACTURING_SERVICES) || (defined NXTR_MANUFACTURING_SERVICES)
#  if (!defined RTE_CONST_NXTR_MANUFACTURING_SERVICES) || (RTE_CONST_NXTR_MANUFACTURING_SERVICES != 126U)
#   error "Enumeration constant <NXTR_MANUFACTURING_SERVICES> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NXTR_MANUFACTURING_SERVICES (126U)
#  define NXTR_MANUFACTURING_SERVICES (126U)
# endif
